...
interface ProjectViewErrorStateProps {
  onRetry: () => void;
}

export function ProjectViewErrorState({ onRetry }: ProjectViewErrorStateProps) {
  return (
      ...
      <div className="flex flex-col items-center gap-4 rounded-xl border border-border bg-card px-8 py-10 text-center max-w-sm w-full shadow-sm">
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <p className="text-sm text-muted-foreground">
            There was a problem loading this project's data. Please try again.
          </p>
        </div>
